                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input style="border-color:#9794af;" name="price" type="number" class="form-control" required>
                                                </div>
                                            </div>
                                ...
                                <div class="table-responsive">
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        ...
                                        @foreach ($allStock as $stock)
                                            ...
                                            @include('stock.partials.edit', [$stock, $shops])

                                            @include('stock.partials.delete', $stock)
